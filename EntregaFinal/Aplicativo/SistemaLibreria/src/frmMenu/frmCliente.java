...
public class frmCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblTablaCliente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tblTablaClienteMousePressed(evt);
            }
        });
        tblTablaCliente.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tblTablaClienteKeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(tblTablaCliente);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        c.setsNombre(txtSNombre.getText());
        c.setpApellido(txtPApellido.getText());
        c.setsApellido(txtSApellido.getText());
        c.setDireccion(txtDireccion.getText());
        c.setCorreo(txtCorreo.getText());
        c.setNoIdentidad(txtNoIdentidad.getText());
        db.ActualizarRegistro(c);
        LimpiarFormulario();
        ListarDatos();
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        Cliente c = new Cliente();
        c.setNoIdentidad(txtNoIdentidad.getText());
        db.EliminarRegistro(c);
        LimpiarFormulario();
        ListarDatos();
    }//GEN-LAST:event_btnEliminarActionPerformed

    private void tblTablaClienteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTablaClienteMousePressed
    ...
    private void tblTablaClienteKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblTablaClienteKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tblTablaClienteKeyPressed
